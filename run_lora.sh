...
srun --ntasks=3 --ntasks-per-node=1 \
  ...
  bash -c "
    ...
    PRETRAINED_PATH=\"/home/Competition2025/P02/shareP02/DeepSeek-R1-0528-BF16\"
    PRESHARD_PATH=\"/nvme56/models/R1-0528-pre-sharded-pp3-ep8\"
